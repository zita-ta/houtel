...
<body>
        ...
        <div class="hotel-grid">
            ...
            <div class="hotel-card">
                ...
                <div class="hotel-card-content">
                    ...
                    <?php else: ?>
                        <a href="login.php" class="cream-btn">Login to Book</a>
                    <?php endif; ?>
                </div>
            </div>
            <?php endwhile; ?>
    ...
    window.addEventListener('DOMContentLoaded',()=>{
        ...
        showToast('info','Kamu telah berhasil logout. Sampai jumpa!');
        <?php endif; ?>
        <?php if(isset($_GET['registered'])): ?>
        showToast('success','Registrasi berhasil! Silakan login untuk melanjutkan.');
        <?php endif; ?>
        <?php if(!isset($_SESSION['user_id'])): ?>
        // Guest hint
        document.querySelectorAll('a[href="login.php"]').forEach(btn=>{
            if(btn.textContent.includes('Login to Book')){
                btn.addEventListener('click',()=>showToast('info','Login dulu untuk melakukan booking!'));
            }
        });
        <?php endif; ?>
    });
